...
public class CodeTransformationTestGenerated extends AbstractCodeTransformationTest {
    ...
    public static class ReplaceGetWithBrackets extends AbstractCodeTransformationTest {
        ...
        @TestMetadata("cantReplace_functionLiteralInArgumentList.kt")
        public void testCantReplace_functionLiteralInArgumentList() throws Exception {
            doTestReplaceGetWithBrackets("idea/testData/intentions/replaceGetWithBrackets/cantReplace_functionLiteralInArgumentList.kt");
        }
